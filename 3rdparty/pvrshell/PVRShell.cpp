...
@Input			ui32Width		the width of the data
@Input			ui32Height		the height of the data
...
/*!***********************************************************************
 @Function		TouchBegan
 @Input			vec2Location The position of a click/touch on the screen when 
				it first touches
 @description	Used by the OS-specific code to tell the Shell that a touch 
				has began at a location.
*************************************************************************/
...
/*!***********************************************************************
 @Function		TouchMoved
 @Input			vec2Location The position of the pointer/touch pressed on the screen
 @description	Used by the OS-specific code to tell the Shell that a touch 
				has began at a location.
*************************************************************************/
...
/*!***********************************************************************
 @Function		TouchEnded
 @Input			vec2Location The position of the pointer/touch on the screen 
				when it is released
 @description	Used by the OS-specific code to tell the Shell that the
				current touch has ended at a location.
*************************************************************************/
