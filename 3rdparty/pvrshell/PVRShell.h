...
public:
	...
	*************************************************************************/
	...
	/*!***********************************************************************
	 ...
	 @Input			Width               size of image
	 @Input			Height              size of image
	 @Input			pLines              image data to write out (24bpp, 8-bit per channel RGB)
	 @Input			ui32PixelReplicate	expand pixels through replication (1 = no scale)
