...
public:
	...
	inline const std::vector< JointNode * >& jointList() { return _jointList; }
	inline std::vector< Vec4f >& skinMatRows() { return _skinMatRows; }
	inline const Vec4f* customInstData() { return _customInstData; }
