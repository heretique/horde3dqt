...
public:
	...
	inline PParticleEffectResource effectRes() { return _effectRes; }
	inline uint32 particleCount() { return _particleCount; }
	inline const ParticleData* particles() { return _particles; }
	inline const float* parPositions() { return _parPositions; }
	inline const float* parSizesANDRotations() { return _parSizesANDRotations; }
	inline const float* parColors() { return _parColors; }
