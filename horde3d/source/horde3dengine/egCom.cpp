...
StatManager::StatManager()
{
	...
	_fwdLightsGPUTimer = Modules::rdMan().createGPUTimer(Modules::renderDeviceType());
	_defLightsGPUTimer = Modules::rdMan().createGPUTimer(Modules::renderDeviceType());
	_shadowsGPUTimer = Modules::rdMan().createGPUTimer(Modules::renderDeviceType());
	_particleGPUTimer = Modules::rdMan().createGPUTimer(Modules::renderDeviceType());
}
...
IGPUTimer *StatManager::getGPUTimer( int param )
{
	switch( param )
	{
	case EngineStats::FwdLightsGPUTime:
