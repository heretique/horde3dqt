...
public:
	...
	inline PShaderResource shaderRes() { return _shaderRes; }
	inline PMaterialResource materialLink() { return _matLink; }
	inline uint32 combinationMask() { return _combMask; }
	inline std::vector< MatSampler >& samplers() { return _samplers; }
	inline std::vector< MatUniform >& uniforms() { return _uniforms; }
