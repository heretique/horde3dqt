...
public:
	...
	static IRenderer &renderer() { return *_renderer; }
	static ExtensionManager &extMan() { return *_extensionManager; }
	static RenderManager &rdMan() { return *_renderManager; }

public:
	static const char *versionString;

private:
	static void installRenderers();
	static void installExtensions();

private:
	static bool                   _errorFlag;
	static int					  _rendererType;
