...
struct  H3DRenderers
{
	/* Enum: H3DRenderDevices
			The available render device implementations.
		
		MaxLogLevel         - Defines the maximum log level; only messages which are smaller or equal to this value
		OpenGL_2_0			- OpenGL 2.0 and above renderer implementation
		OpenGL_ES_2_0		- OpenGL ES 2.0 renderer implementation
		OpenGL_ES_3_0		- OpenGL ES 3.0 renderer implementation
	*/
	enum List
	{
		OpenGL_2_0,
...
/* Function: h3dInit
	...
	Parameters:
		param - render device type
		
	Returns:
		true in case of success, otherwise false
*/
DLL bool h3dInit(H3DRenderers::List param);
