...
OpenGLESRenderer::OpenGLESRenderer() : _rd(0x0)
{
    _scratchBuf = 0x0;
    _overlayVerts = 0x0;
    _scratchBufSize = 0;
...
IRenderer* OpenGLESRenderer::factoryFunc()
{
    return new OpenGLESRenderer();
}

IRenderDevice* OpenGLESRenderer::renderDevice()
{
    return _rd;
}

void OpenGLESRenderer::registerRenderFunc( int nodeType, RenderFunc rf )
{
...
unsigned char *OpenGLESRenderer::useScratchBuf( uint32 minSize )
{
...
void OpenGLESRenderer::initStates()
{
    _rd->initStates();
}

void OpenGLESRenderer::initInternalRenderFuncs( int nodeType )
{
    switch (nodeType)
    {
...
void OpenGLESRenderer::setupViewMatrices( const Matrix4f &viewMat, const Matrix4f &projMat )
{
...
void OpenGLESRenderer::createPrimitives()
{
    // Unit cube
...
void OpenGLESRenderer::unregisterOccSet( int occSet )
{
...
void OpenGLESRenderer::drawRenderables( const string &shaderContext, const string &theClass, bool debugView,
...
void OpenGLESRenderer::drawMeshes( uint32 firstItem, uint32 lastItem, const string &shaderContext, const string &theClass,
...
void OpenGLESRenderer::drawParticles( uint32 firstItem, uint32 lastItem, const string &shaderContext, const string &theClass,
                                      bool debugView, const Frustum *frust1, const Frustum * /*frust2*/, RenderingOrder::List /*order*/,
                                      int occSet )
{
    // we know this is the renderer otherwise the method is not called for this class
