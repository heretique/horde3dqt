...
#ifndef _egOpenGLESRenderDevice_H_
#define _egOpenGLESRenderDevice_H_
...
#define VERTEX_BUFFER_SLOTS 16
	...
	class OpenGLESRenderDevice: public IRenderDevice
	{
	public:

		OpenGLESRenderDevice();
		virtual ~OpenGLESRenderDevice();
...
#endif // _egOpenGLESRenderDevice_H_
